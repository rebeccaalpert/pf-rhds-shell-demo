...
import { n as createComponent, t as customElement } from "./custom-element-LOfcoEEs.js";
import { n as html, s as css, t as LitElement } from "./lit-DoqJFewF.js";
import "./rh-footer-copyright-CiymXtYO.js";
import { a as property, i as classMap, o as InternalsController, r as colorPalettes, s as SlotController } from "./rh-icon-9k_wCkus.js";
//#region node_modules/@rhds/elements/elements/rh-footer/rh-footer-universal.js
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var _RhFooterUniversal_instances;
var _RhFooterUniversal_internals;
var _RhFooterUniversal_slots;
var _RhFooterUniversal_hasAncestorH2;
var _RhFooterUniversal_detectAncestorH2;
var _RhFooterUniversal_updateRole;
var style = css`:host{color:var(--rh-color-white,#fff);font-family:var(--rh-font-family-body-text,RedHatText,"Red Hat Text",Helvetica,Arial,sans-serif);line-height:var(--rh-line-height-body-text,1.5);font-weight:var(--_font-weight);font-size:medium;display:flex;flex-direction:column;color-scheme:only dark!important}@media (scripting:none){:host{min-height:var(--rh-footer-nojs-min-height)}}::slotted(rh-footer-universal),:host{--_fallback-animation:nothing-doing!important;--_fallback-opacity:1!important;overflow-y:initial}.base{border-block-start:var(--rh-border-width-sm,1px) solid var(--_border-color)}.footer,.global-base{--_icon-color:var(
...
*/
var RhFooterUniversal = class RhFooterUniversal extends LitElement {
	constructor() {
		super(...arguments);
...
_RhFooterUniversal_internals = /* @__PURE__ */ new WeakMap();
_RhFooterUniversal_slots = /* @__PURE__ */ new WeakMap();
_RhFooterUniversal_hasAncestorH2 = /* @__PURE__ */ new WeakMap();
_RhFooterUniversal_instances = /* @__PURE__ */ new WeakSet();
_RhFooterUniversal_detectAncestorH2 = function _RhFooterUniversal_detectAncestorH2() {
	let node = this.parentElement;
	while (node) {
		if (node?.closest("h2") || node?.querySelector("h2") || node?.shadowRoot?.querySelector("h2")) return true;
...
_RhFooterUniversal_updateRole = function _RhFooterUniversal_updateRole() {
	...
	if (!hasFooterAncestor) __classPrivateFieldGet(this, _RhFooterUniversal_internals, "f").role = "contentinfo";
};
...
RhFooterUniversal = __decorate([customElement("rh-footer-universal"), colorPalettes], RhFooterUniversal);
//#endregion
//#region node_modules/@rhds/elements/react/rh-footer/rh-footer-universal.js
var FooterUniversal = createComponent({
	tagName: "rh-footer-universal",
	elementClass: RhFooterUniversal,
	react: import_react.default,
	events: {}
});
//#endregion
export { FooterUniversal };
