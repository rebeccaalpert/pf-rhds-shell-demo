...
const DropdownBase = (_a) => {
    ...
    const containerOuiaProps = (0, helpers_1.useOUIAProps)('Dropdown container', containerOuiaId, containerOuiaSafe);
    ...
    const menu = ((0, jsx_runtime_1.jsx)(Menu_1.Menu, Object.assign({ className: (0, react_styles_1.css)(className), ref: menuRef, onSelect: (event, value) => {
            var _a;
            onSelect && onSelect(event, value);
            shouldFocusToggleOnSelect && ((_a = toggleRef.current) === null || _a === void 0 ? void 0 : _a.focus());
        }, isPlain: isPlain, isScrollable: scrollable }, props, ouiaProps, { children: (0, jsx_runtime_1.jsx)(Menu_1.MenuContent, { menuHeight: menuHeight, maxMenuHeight: maxMenuHeight, children: children }) })));
    const popper = ((0, jsx_runtime_1.jsx)(Popper_1.Popper, Object.assign({ trigger: typeof toggle === 'function' ? toggle(toggleRef) : toggle.toggleNode, triggerRef: toggleRef, popper: menu, popperRef: menuRef, isVisible: isOpen, zIndex: zIndex }, popperProps)));
    return containerOuiaId ? (0, jsx_runtime_1.jsx)(ContainerComponent, Object.assign({}, containerOuiaProps, { children: popper })) : popper;
};
exports.Dropdown = (0, react_1.forwardRef)((props, ref) => ((0, jsx_runtime_1.jsx)(DropdownBase, Object.assign({ innerRef: ref }, props))));
