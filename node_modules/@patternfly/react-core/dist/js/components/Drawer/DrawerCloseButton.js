...
const DrawerCloseButton = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, react_styles_1.css)(drawer_1.default.drawerClose, className) }, props, { children: (0, jsx_runtime_1.jsx)(Button_1.Button, { variant: "plain", onClick: onClose, "aria-label": ariaLabel, icon: (0, jsx_runtime_1.jsx)(rh_microns_close_icon_1.default, {}) }) })));
};
