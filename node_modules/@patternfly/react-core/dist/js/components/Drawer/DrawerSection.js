...
const DrawerSection = (_a) => {
    var { className = '', children, colorVariant = Drawer_1.DrawerColorVariant.default, isPlain = false } = _a, props = tslib_1.__rest(_a, ["className", "children", "colorVariant", "isPlain"]);
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, react_styles_1.css)(drawer_1.default.drawerSection, isPlain && drawer_1.default.modifiers.plain, colorVariant === Drawer_1.DrawerColorVariant.noBackground && drawer_1.default.modifiers.noBackground, colorVariant === Drawer_1.DrawerColorVariant.secondary && drawer_1.default.modifiers.secondary, className) }, props, { children: children })));
};
