...
const DualListSelector = (_a) => {
    var { className, children, id, isTree = false, hasAnimations: hasAnimationsProp } = _a, props = tslib_1.__rest(_a, ["className", "children", "id", "isTree", "hasAnimations"]);
    const hasAnimations = (0, helpers_2.useHasAnimations)(hasAnimationsProp);
    const randomId = (0, helpers_1.useSSRSafeId)();
    return ((0, jsx_runtime_1.jsx)(DualListSelectorContext_1.DualListSelectorContext.Provider, { value: { isTree, hasAnimations }, children: (0, jsx_runtime_1.jsx)("div", Object.assign({ className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelector, hasAnimations && isTree && dual_list_selector_1.default.modifiers.animateExpand, className), id: id || randomId }, props, { children: children })) }));
};
exports.DualListSelector = DualListSelector;
exports.DualListSelector.displayName = 'DualListSelector';
