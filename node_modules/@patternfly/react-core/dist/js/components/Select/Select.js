...
const SelectBase = (_a) => {
    ...
    const generatedOuiaId = (0, ouia_1.useOUIAId)(exports.Select.displayName, props.ouiaId);
    ...
    const menu = ((0, jsx_runtime_1.jsx)(Menu_1.Menu, Object.assign({ role: role, className: (0, react_styles_1.css)(className), ref: menuRef, onSelect: (event, value) => {
        ...
        }, isPlain: isPlain, selected: selected, isScrollable: isScrollable !== null && isScrollable !== void 0 ? isScrollable : (menuHeight !== undefined || maxMenuHeight !== undefined) }, (0, helpers_1.getOUIAProps)(exports.Select.displayName, generatedOuiaId, props.ouiaSafe !== undefined ? props.ouiaSafe : true), props, { children: (0, jsx_runtime_1.jsx)(Menu_1.MenuContent, { menuHeight: menuHeight, maxMenuHeight: maxMenuHeight, children: children }) })));
