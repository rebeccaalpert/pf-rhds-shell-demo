...
const rh_ui_star_icon_1 = tslib_1.__importDefault(require('@patternfly/react-icons/dist/js/icons/rh-ui-star-icon'));
...
const ButtonBase = (_a) => {
    ...
    const renderIcon = () => {
        let iconContent;
        if (isFavorite) {
            iconContent = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: (0, react_styles_1.css)('pf-v6-c-button__icon-favorite'), children: (0, jsx_runtime_1.jsx)(rh_ui_star_icon_1.default, {}) }), (0, jsx_runtime_1.jsx)("span", { className: (0, react_styles_1.css)('pf-v6-c-button__icon-favorited'), children: (0, jsx_runtime_1.jsx)(rh_ui_star_fill_icon_1.default, {}) })] }));
        }
        if (isSettings) {
            iconContent = (0, jsx_runtime_1.jsx)(rh_ui_settings_fill_icon_1.default, {});
        }
        if (isHamburger) {
