...
const DataListBase = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(exports.DataListContext.Provider, { value: {
        ...
        }, children: (0, jsx_runtime_1.jsx)("ul", Object.assign({ className: (0, react_styles_1.css)(data_list_1.default.dataList, isCompact && data_list_1.default.modifiers.compact, isPlain && data_list_1.default.modifiers.plain, isNoPlainOnGlass && data_list_1.default.modifiers.noPlainOnGlass, gridBreakpointClasses[gridBreakpoint], wrapModifier && data_list_1.default.modifiers[wrapModifier], className), style: props.style, role: "list", "aria-label": ariaLabel, ref: innerRef }, props, { children: children })) }));
};
