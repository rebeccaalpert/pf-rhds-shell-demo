...
const ModalBoxCloseButton = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(modal_box_1.default.modalBoxClose, className), children: (0, jsx_runtime_1.jsx)(Button_1.Button, Object.assign({ variant: "plain", onClick: (event) => onClose(event), "aria-label": ariaLabel }, (ouiaId && { ouiaId: `${ouiaId}-${exports.ModalBoxCloseButton.displayName}` }), props, { icon: (0, jsx_runtime_1.jsx)(rh_microns_close_icon_1.default, {}) })) }));
};
