...
const c_description_list__term_width_1 = tslib_1.__importDefault(require('@patternfly/react-tokens/dist/js/c_description_list__term_width'));
...
const DescriptionList = (_a) => {
    ...
    if (termWidth) {
        style = Object.assign(Object.assign({}, style), { [c_description_list__term_width_1.default.name]: termWidth });
    }
