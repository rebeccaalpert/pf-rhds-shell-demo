...
const rh_microns_caret_down_fill_icon_1 = tslib_1.__importDefault(require('@patternfly/react-icons/dist/js/icons/rh-microns-caret-down-fill-icon'));
...
const SearchInputBase = (_a) => {
    ...
    const buildSearchTextInputGroupWithExtraButtons = (_a = {}) => {
        ...
        return ((0, jsx_runtime_1.jsxs)(InputGroup_1.InputGroup, Object.assign({ ref: triggerRef }, searchInputProps, { children: [(0, jsx_runtime_1.jsx)(InputGroup_1.InputGroupItem, Object.assign({}, (!hasAnimations && { isFill: true }), (expandableInput && hasAnimations && { className: input_group_1.default.modifiers.searchInput }), (expandableInput &&
                    ...
                    !isExpanded && {
                    inert: ''
                }), { children: buildTextInputGroup() })), (attributes.length > 0 || onToggleAdvancedSearch) && ((0, jsx_runtime_1.jsx)(InputGroup_1.InputGroupItem, Object.assign({ isPlain: true }, (hasAnimations && { className: input_group_1.default.modifiers.searchAction }), { children: (0, jsx_runtime_1.jsx)(Button_1.Button, { className: isSearchMenuOpen && 'pf-m-expanded', variant: Button_1.ButtonVariant.control, "aria-label": openMenuButtonAriaLabel, onClick: onToggle, isDisabled: isDisabled, "aria-expanded": isSearchMenuOpen, icon: (0, jsx_runtime_1.jsx)(rh_microns_caret_down_fill_icon_1.default, {}) }) }))), !!onSearch && ((0, jsx_runtime_1.jsx)(InputGroup_1.InputGroupItem, Object.assign({}, (hasAnimations && { className: input_group_1.default.modifiers.searchAction }), { children: (0, jsx_runtime_1.jsx)(Button_1.Button, { type: "submit", variant: Button_1.ButtonVariant.control, "aria-label": submitSearchButtonLabel, onClick: onSearchHandler, isDisabled: isDisabled, icon: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { shouldMirrorRTL: true, children: (0, jsx_runtime_1.jsx)(rh_microns_caret_right_icon_1.default, {}) }) }) }))), expandableInput && (0, jsx_runtime_1.jsx)(InputGroup_1.InputGroupItem, { children: expandableToggle })] })));
    };
