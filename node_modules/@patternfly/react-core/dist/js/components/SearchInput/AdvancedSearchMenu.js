...
const AdvancedSearchMenu = ({ className, parentRef, parentInputRef, value = '', attributes = [], formAdditionalItems, hasWordsAttrLabel = 'Has words', advancedSearchDelimiter, getAttrValueMap, onChange, onSearch, onClear, resetButtonLabel = 'Reset', submitSearchButtonLabel = 'Search', isSearchMenuOpen, onToggleAdvancedMenu }) => {
    const hasWordsId = (0, helpers_1.useSSRSafeId)();
    ...
    const buildFormGroups = () => {
        ...
        formGroups.push((0, jsx_runtime_1.jsx)(Form_1.FormGroup, { label: hasWordsAttrLabel, fieldId: hasWordsId, children: (0, jsx_runtime_1.jsx)(TextInput_1.TextInput, { type: "text", id: hasWordsId, value: getValue('haswords'), onChange: (evt, value) => handleValueChange('haswords', value, evt) }) }, "hasWords"));
        return formGroups;
    };
