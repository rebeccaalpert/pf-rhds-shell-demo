...
class Nav extends react_1.Component {
    ...
    render() {
        ...
        onSelect, 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        onToggle, ouiaId, ouiaSafe, variant, isTextExpanded = false } = _a, props = tslib_1.__rest(_a, ['aria-label', "children", "className", "onSelect", "onToggle", "ouiaId", "ouiaSafe", "variant", "isTextExpanded"]);
        const isHorizontal = ['horizontal', 'horizontal-subnav'].includes(variant);
        const isDocked = variant === 'docked';
        return ((0, jsx_runtime_1.jsx)(SSRSafeIds_1.SSRSafeIds, { prefix: "pf-", ouiaComponentType: `Nav${variant ? `-${variant}` : ''}`, children: (_, generatedOuiaId) => ((0, jsx_runtime_1.jsx)(exports.NavContext.Provider, { value: {
                    ...
                    navRef: this.navRef
                }, children: (0, jsx_runtime_1.jsx)("nav", Object.assign({ className: (0, react_styles_1.css)(nav_1.default.nav, isHorizontal && nav_1.default.modifiers.horizontal, isDocked && nav_1.default.modifiers.docked, variant === 'horizontal-subnav' && nav_1.default.modifiers.subnav, isDocked && isTextExpanded && nav_1.default.modifiers.textExpanded, this.state.isScrollable && nav_1.default.modifiers.scrollable, className), "aria-label": ariaLabel || (variant === 'horizontal-subnav' ? 'Local' : 'Global'), ref: this.navRef }, (0, helpers_1.getOUIAProps)(Nav.displayName, ouiaId !== undefined ? ouiaId : generatedOuiaId, ouiaSafe), props, { children: children })) })) }));
    }
}
exports.Nav = Nav;
Nav.displayName = 'Nav';
