...
const rh_ui_clock_icon_1 = tslib_1.__importDefault(require('@patternfly/react-icons/dist/js/icons/rh-ui-clock-icon'));
...
class TimePicker extends react_1.Component {
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsx)(helpers_1.GenerateId, { prefix: "time-picker-", children: (generatedId) => {
                ...
                const textInput = ((0, jsx_runtime_1.jsx)(TextInput_1.TextInput, Object.assign({ "aria-haspopup": "menu", id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", customIcon: (0, jsx_runtime_1.jsx)(rh_ui_clock_icon_1.default, {}), onClick: this.onInputClick, onChange: this.onInputChange, autoComplete: "off", isDisabled: isDisabled, isExpanded: isTimeOptionsOpen, ref: this.inputRef }, inputProps)));
