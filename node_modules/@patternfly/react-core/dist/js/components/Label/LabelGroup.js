...
class LabelGroup extends react_1.Component {
    ...
    render() {
        ...
        const renderLabelGroup = (id) => {
            ...
            const close = ((0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(label_group_1.default.labelGroupClose), children: (0, jsx_runtime_1.jsx)(Button_1.Button, { variant: "plain", size: "sm", "aria-label": closeBtnAriaLabel, onClick: onClick, id: `remove_group_${id}`, "aria-labelledby": `remove_group_${id} ${id}`, icon: (0, jsx_runtime_1.jsx)(rh_microns_close_icon_1.default, {}) }) }));
