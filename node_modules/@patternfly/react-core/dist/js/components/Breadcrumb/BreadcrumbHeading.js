...
const BreadcrumbHeading = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("li", Object.assign({}, props, { className: (0, react_styles_1.css)(breadcrumb_1.default.breadcrumbItem, className), children: [showDivider && ((0, jsx_runtime_1.jsx)("span", { className: breadcrumb_1.default.breadcrumbItemDivider, children: (0, jsx_runtime_1.jsx)(rh_microns_caret_right_icon_1.default, {}) })), (0, jsx_runtime_1.jsxs)("h1", { className: breadcrumb_1.default.breadcrumbHeading, children: [!to && component === 'button' && ((0, jsx_runtime_1.jsx)("button", { className: (0, react_styles_1.css)(breadcrumb_1.default.breadcrumbLink, breadcrumb_1.default.modifiers.current), "aria-current": true, type: "button", children: children })), to && ((0, jsx_runtime_1.jsx)(Component, { href: to, target: target, className: (0, react_styles_1.css)(breadcrumb_1.default.breadcrumbLink, breadcrumb_1.default.modifiers.current), "aria-current": "page", children: children })), !to && component !== 'button' && (0, jsx_runtime_1.jsx)(react_1.Fragment, { children: children })] })] })));
};
