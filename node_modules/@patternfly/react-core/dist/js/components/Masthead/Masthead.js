...
const Masthead = (_a) => {
    var { children, className, display = {
        md: 'inline'
    }, inset, variant = 'default' } = _a, props = tslib_1.__rest(_a, ["children", "className", "display", "inset", "variant"]);
    const { width, getBreakpoint } = (0, react_1.useContext)(PageContext_1.PageContext);
    return ((0, jsx_runtime_1.jsx)("header", Object.assign({ className: (0, react_styles_1.css)(masthead_1.default.masthead, variant === 'docked' && masthead_1.default.modifiers.docked, (0, util_1.formatBreakpointMods)(display, masthead_1.default, 'display-', getBreakpoint(width)), (0, util_1.formatBreakpointMods)(inset, masthead_1.default, '', getBreakpoint(width)), className) }, props, { children: children })));
};
