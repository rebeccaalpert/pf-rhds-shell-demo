...
class Tabs extends react_1.Component {
    ...
    render() {
        ...
        const Component = component !== undefined ? component : defaultComponent;
        ...
        return ((0, jsx_runtime_1.jsx)(SSRSafeIds_1.SSRSafeIds, { prefix: "pf-random-id-", ouiaComponentType: Tabs.displayName, children: (generatedId, generatedOuiaId) => {
                ...
                return ((0, jsx_runtime_1.jsxs)(TabsContext_1.TabsContextProvider, { value: {
                    ...
                    }, children: [(0, jsx_runtime_1.jsxs)(Component, Object.assign({ "aria-label": ariaLabel, className: (0, react_styles_1.css)(tabs_1.default.tabs, tabs_1.default.modifiers.animateCurrent, isFilled && tabs_1.default.modifiers.fill, isSubtab && tabs_1.default.modifiers.subtab, isNav && tabs_1.default.modifiers.nav, isVertical && tabs_1.default.modifiers.vertical, isVertical && expandable && (0, util_1.formatBreakpointMods)(expandable, tabs_1.default), isVertical && expandable && isExpandedLocal && tabs_1.default.modifiers.expanded, isBox && tabs_1.default.modifiers.box, showScrollButtons && tabs_1.default.modifiers.scrollable, usePageInsets && tabs_1.default.modifiers.pageInsets, hasNoBorderBottom && tabs_1.default.modifiers.noBorderBottom, (0, util_1.formatBreakpointMods)(inset, tabs_1.default), variantStyle[variant], hasOverflowTab && tabs_1.default.modifiers.overflow, isInitializingAccent && tabs_1.default.modifiers.initializingAccent, className) }, (0, helpers_1.getOUIAProps)(Tabs.displayName, ouiaId !== undefined ? ouiaId : generatedOuiaId, ouiaSafe), { id: id && id }, props, { style: Object.assign({ [c_tabs_link_accent_length_1.default.name]: currentLinkAccentLength, [c_tabs_link_accent_start_1.default.name]: currentLinkAccentStart }, props.style), children: [expandable && isVertical && ((0, jsx_runtime_1.jsx)(GenerateId_1.GenerateId, { children: (randomId) => ((0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsToggle), children: (0, jsx_runtime_1.jsx)("div", { className: 'pf-v6-c-tabs__toggle-button', children: (0, jsx_runtime_1.jsx)(Button_1.Button, { onClick: (event) => toggleTabs(event, !isExpandedLocal), variant: "plain", "aria-label": toggleAriaLabel, "aria-expanded": isExpandedLocal, id: `${randomId}-button`, "aria-labelledby": `${randomId}-text ${randomId}-button`, icon: (0, jsx_runtime_1.jsx)("span", { className: (0, react_styles_1.css)(tabs_1.default.tabsToggleIcon), children: (0, jsx_runtime_1.jsx)(rh_microns_caret_down_icon_1.default, {}) }), children: toggleText && (0, jsx_runtime_1.jsx)("span", { id: `${randomId}-text`, children: toggleText }) }) }) })) })), renderScrollButtons && ((0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsScrollButton), children: (0, jsx_runtime_1.jsx)(Button_1.Button, { "aria-label": backScrollAriaLabel || leftScrollAriaLabel, onClick: this.scrollBack, isDisabled: disableBackScrollButton, "aria-hidden": disableBackScrollButton, ref: this.leftScrollButtonRef, variant: "plain", icon: (0, jsx_runtime_1.jsx)(rh_microns_caret_left_icon_1.default, {}) }) })), (0, jsx_runtime_1.jsxs)("ul", { "aria-label": tabListAriaLabel, "aria-labelledby": tabListAriaLabelledBy, className: (0, react_styles_1.css)(tabs_1.default.tabsList), ref: this.tabList, onScroll: this.handleScrollButtons, role: "tablist", children: [isOverflowHorizontal ? filteredChildrenWithoutOverflow : filteredChildren, hasOverflowTab && (0, jsx_runtime_1.jsx)(OverflowTab_1.OverflowTab, Object.assign({ overflowingTabs: overflowingTabProps }, overflowObjectProps))] }), renderScrollButtons && ((0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsScrollButton), children: (0, jsx_runtime_1.jsx)(Button_1.Button, { "aria-label": forwardScrollAriaLabel || rightScrollAriaLabel, onClick: this.scrollForward, isDisabled: disableForwardScrollButton, "aria-hidden": disableForwardScrollButton, variant: "plain", icon: (0, jsx_runtime_1.jsx)(rh_microns_caret_right_icon_1.default, {}) }) })), onAdd !== undefined && ((0, jsx_runtime_1.jsx)("span", { className: (0, react_styles_1.css)(tabs_1.default.tabsAdd), children: (0, jsx_runtime_1.jsx)(Button_1.Button, { variant: "plain", "aria-label": addButtonAriaLabel || 'Add tab', onClick: onAdd, icon: (0, jsx_runtime_1.jsx)(plus_icon_1.default, {}), isDisabled: isAddButtonDisabled }) }))] })), filteredChildren
