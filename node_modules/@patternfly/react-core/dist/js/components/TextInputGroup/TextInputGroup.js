...
const TextInputGroup = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(exports.TextInputGroupContext.Provider, { value: { isDisabled, validated }, children: (0, jsx_runtime_1.jsx)("div", Object.assign({ ref: textInputGroupRef, className: (0, react_styles_1.css)(text_input_group_1.default.textInputGroup, isDisabled && text_input_group_1.default.modifiers.disabled, isPlain && text_input_group_1.default.modifiers.plain, hasValidatedModifier && text_input_group_1.default.modifiers[validated], className) }, props, { children: children })) }));
};
