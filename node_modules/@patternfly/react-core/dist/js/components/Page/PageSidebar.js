...
const PageSidebar = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(PageContext_1.PageContextConsumer, { children: ({ isManagedSidebar, isSidebarOpen: managedIsNavOpen, isMobile }) => {
            const sidebarOpen = isManagedSidebar ? managedIsNavOpen : isSidebarOpen;
            return ((0, jsx_runtime_1.jsx)("div", Object.assign({ id: id, className: (0, react_styles_1.css)(page_1.default.pageSidebar, sidebarOpen && isMobile && page_1.default.modifiers.expanded, !sidebarOpen && page_1.default.modifiers.collapsed, className), "aria-hidden": !sidebarOpen }, props, { children: (0, jsx_runtime_1.jsx)(exports.PageSidebarContext.Provider, { value: { isSidebarOpen: sidebarOpen }, children: (0, jsx_runtime_1.jsx)("div", { className: (0, react_styles_1.css)(page_1.default.pageSidebarMain), children: children }) }) })));
        } }));
};
