...
export declare const RhUiTrashFillIconConfig: {
  name: 'RhUiTrashFillIcon',
...
export declare const RhUiTrashFillIcon: ComponentClass<SVGIconProps>;
export default RhUiTrashFillIcon;