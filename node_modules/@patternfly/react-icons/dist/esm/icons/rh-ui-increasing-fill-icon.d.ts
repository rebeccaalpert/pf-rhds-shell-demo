...
export declare const RhUiIncreasingFillIconConfig: {
  name: 'RhUiIncreasingFillIcon',
...
export declare const RhUiIncreasingFillIcon: ComponentClass<SVGIconProps>;
export default RhUiIncreasingFillIcon;